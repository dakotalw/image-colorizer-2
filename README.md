...
- Applies Canny edge detection algorithm (OpenCV) to the image to extract edges and convert it into a binary image      
- Uses memory-efficient attention (enable_xformers_memory_efficient_attention())                                      
